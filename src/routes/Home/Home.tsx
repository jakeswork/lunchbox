...
import { Text, Button, Input, Modal, Header } from '../../components';
  ...
  return (
    <>
      ...
      <main className={classes.main}>
        <img src={header} alt="People sharing food" className={classes.headingImg} />
        <div>
          <Text h1 primaryColor>Find the food<br/>for everyone.</Text>
          <Text h4>Vote for the next place to eat from<br/>over thousands of local restaurants<br/>and cuisines.</Text>
        ...
        >
          ...
          >
            <div className={classes.slide}>
              ...
              <Text className={classes.subheading}>To start off, enter a username below</Text>
              <div>
                <Input
                  autoFocus
                  width="100%"
            ...
            <div className={classes.slide}>
              ...
              <Text className={classes.subheading}>Where are we eating today?</Text>
              <SearchCities
